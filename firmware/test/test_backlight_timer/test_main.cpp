...
void test_accepts_exactly_the_nine_timeout_choices() {
  ...
  TEST_ASSERT_FALSE(backlight_timer::isSupportedTimeout(0));
  TEST_ASSERT_FALSE(backlight_timer::isSupportedTimeout(14));
  TEST_ASSERT_FALSE(backlight_timer::isSupportedTimeout(16));
  TEST_ASSERT_FALSE(backlight_timer::isSupportedTimeout(7201));
}
...
int runTests() {
  UNITY_BEGIN();
  RUN_TEST(test_accepts_exactly_the_nine_timeout_choices);
